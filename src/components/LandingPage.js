...
export default class LandingPage extends Component {
    render() {
        return (
          <Carousel autoPlay infiniteLoop emulateTouch showArrows={false} showIndicators={false} showStatus={false} showThumbs={false}  >
              <div>
                  <div className='legend' style={legendHack}>
                    <h1 style={{fontSize: '50px'}}> Trings</h1>
                    <h4 style={{fontSize: '20px'}}> Unlock the gems in your city </h4>
                   </div>
